...
import { a9 as HeadlessB2BOAuthClient$1, _ as __awaiter, e as OneTapPositions, a2 as StytchSDKUsageError, l as logger, aa as loadESModule, ab as IframeHostClient, ac as EventLogger, ad as DEFAULT_MAX_BATCH_SIZE, ae as DEFAULT_INTERVAL_DURATION_MS, af as createEventId, ag as createAppSessionId, ah as createPersistentId, ai as baseFetchSDK, aj as _retriableFetchSDK, ak as STYTCH_WEB_BACKEND_URL, al as TEST_API_URL, am as LIVE_API_URL, an as STYTCH_DFP_BACKEND_URL, ao as CLIENTSIDE_SERVICES_IFRAME_URL, ap as validate, aq as GOOGLE_ONE_TAP_HOST, ar as GOOGLE_ONE_TAP_SCRIPT_URL, i as isTestPublicToken, as as checkB2BNotSSR, at as checkPublicToken, au as StateChangeClient, av as DFPProtectedAuthProvider, aw as HeadlessB2BOrganizationClient, ax as HeadlessB2BSelfClient, ay as HeadlessB2BSessionClient, az as HeadlessB2BMagicLinksClient, aA as HeadlessB2BSSOClient, aB as HeadlessB2BDiscoveryClient, aC as HeadlessB2BPasswordsClient, aD as HeadlessB2BOTPsClient, aE as HeadlessB2BTOTPsClient, aF as HeadlessB2BRecoveryCodesClient, aG as HeadlessB2BRBACClient, aH as SessionManager, aI as SearchDataManager, aJ as writeB2BInternals } from './internal-CfUZ681R.js';
...
var buildFinalConfig = function buildFinalConfig(opts) {
  ...
  return {
    ...
    endpoints: {
      ...
      dfpBackendURL: (_h = (_g = opts === null || opts === void 0 ? void 0 : opts.endpoints) === null || _g === void 0 ? void 0 : _g.dfpBackendURL) !== null && _h !== void 0 ? _h : STYTCH_DFP_BACKEND_URL,
      clientsideServicesIframeURL: (_k = (_j = opts === null || opts === void 0 ? void 0 : opts.endpoints) === null || _j === void 0 ? void 0 : _j.clientsideServicesIframeURL) !== null && _k !== void 0 ? _k : CLIENTSIDE_SERVICES_IFRAME_URL
    }
  };
};
...
var SubscriptionDataLayer = /*#__PURE__*/function () {
  function SubscriptionDataLayer(publicToken, options) {
    ...
    this.browserSessionStorage = {
      getItem: function getItem(key) {
        return sessionStorage.getItem(getLocalStorageKey(_this5.publicToken, key));
      },
      setItem: function setItem(key, value) {
        return sessionStorage.setItem(getLocalStorageKey(_this5.publicToken, key), value);
      },
      removeItem: function removeItem(key) {
        return sessionStorage.removeItem(getLocalStorageKey(_this5.publicToken, key));
      }
    };
    ...
    var localStorageState = localStorage.getItem(getLocalStorageKey(this.publicToken));
  ...
  _createClass(SubscriptionDataLayer, [{
    ...
    value: function syncToLocalStorage() {
      localStorage.setItem(getLocalStorageKey(this.publicToken), JSON.stringify(this.state));
    }
  }, {
    key: "getItem",
    value: function getItem(key) {
      return localStorage.getItem(getLocalStorageKey(this.publicToken, key));
    }
  }, {
    key: "setItem",
    value: function setItem(key, value) {
      return localStorage.setItem(getLocalStorageKey(this.publicToken, key), value);
    }
  }, {
    key: "removeItem",
    value: function removeItem(key) {
      return localStorage.removeItem(getLocalStorageKey(this.publicToken, key));
    }
  }], [{
...
var BaseSubscriptionService = /*#__PURE__*/function () {
  function BaseSubscriptionService(_publicToken, _datalayer) {
    ...
    this._listen = function (e) {
      if (e.key !== getLocalStorageKey(_this7._publicToken)) {
        return;
      }
...
var StytchB2BHeadlessClient = /*#__PURE__*/_createClass(function StytchB2BHeadlessClient(_PUBLIC_TOKEN, options) {
  ...
  this.organization = new HeadlessB2BOrganizationClient(this._networkClient, this._subscriptionService);
  this.member = new HeadlessB2BSelfClient(this._networkClient, this._subscriptionService);
  this.self = new HeadlessB2BSelfClient(this._networkClient, this._subscriptionService);
...
export { EMAIL_REGEX as E, StytchB2BHeadlessClient as S, debounce as d };
