...
var buildFinalConfig = function buildFinalConfig(opts) {
  ...
  return {
    ...
    endpoints: {
      sdkBackendURL: (_b = (_a = opts === null || opts === void 0 ? void 0 : opts.endpoints) === null || _a === void 0 ? void 0 : _a.sdkBackendURL) !== null && _b !== void 0 ? _b : internal.STYTCH_WEB_BACKEND_URL,
      testAPIURL: (_d = (_c = opts === null || opts === void 0 ? void 0 : opts.endpoints) === null || _c === void 0 ? void 0 : _c.testAPIURL) !== null && _d !== void 0 ? _d : internal.TEST_API_URL,
      liveAPIURL: (_f = (_e = opts === null || opts === void 0 ? void 0 : opts.endpoints) === null || _e === void 0 ? void 0 : _e.liveAPIURL) !== null && _f !== void 0 ? _f : internal.LIVE_API_URL,
      dfpBackendURL: (_h = (_g = opts === null || opts === void 0 ? void 0 : opts.endpoints) === null || _g === void 0 ? void 0 : _g.dfpBackendURL) !== null && _h !== void 0 ? _h : internal.STYTCH_DFP_BACKEND_URL,
      clientsideServicesIframeURL: (_k = (_j = opts === null || opts === void 0 ? void 0 : opts.endpoints) === null || _j === void 0 ? void 0 : _j.clientsideServicesIframeURL) !== null && _k !== void 0 ? _k : internal.CLIENTSIDE_SERVICES_IFRAME_URL
    }
  };
};
...
var StytchB2BHeadlessClient = /*#__PURE__*/_createClass(function StytchB2BHeadlessClient(_PUBLIC_TOKEN, options) {
  ...
  this.organization = new internal.HeadlessB2BOrganizationClient(this._networkClient, this._subscriptionService);
  this.member = new internal.HeadlessB2BSelfClient(this._networkClient, this._subscriptionService);
  this.self = new internal.HeadlessB2BSelfClient(this._networkClient, this._subscriptionService);
