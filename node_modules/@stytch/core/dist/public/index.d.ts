...
type OrganizationBySlugMatch = Pick<Organization, "organization_id" | "sso_active_connections" | "organization_name" | "organization_logo_url" | "sso_default_connection_id" | "email_jit_provisioning" | "email_allowed_domains" | "auth_methods" | "allowed_auth_methods" | "mfa_policy">;
...
type RNUIOAuthOptions = {
    providers: EnumOrStringLiteral<OAuthProviders>[];
    customScopes?: string[];
    providerParams?: Record<string, string>;
};
type RNUIOTPOptions = {
