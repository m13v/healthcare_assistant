...
import Tracking from '@/public/images/tracking.jpg'
import Doctor from '@/public/images/nurse.png'
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">How Bonsai works</h1>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              {/* <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                <h3 className="h3 mb-3">Take a simple quiz to check eligibility</h3>
                <p className="text-xl text-gray-600"></p>
              </div> */}
              {/* Tabs buttons */}
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">See a clinician online</div>
                    <div className="text-gray-600">Our clinicians ensure you're a fit for our program and write a prescription as necessary.</div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Receive the medication</div>
                    <div className="text-gray-600">A monthly subscription covers any physician visits and medication cost.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Track your journey on our platform</div>
                    <div className="text-gray-600">Log your diet and exercise and optionally get paired with physical trainers and/or food services for weight loss maintenance!</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="relative flex flex-col text-center lg:text-right" data-aos="zoom-y-out" ref={tabs}>
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <Image className="md:max-w-none mx-auto rounded" src={Doctor} width={400} height={400} alt="Physician" />
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <Image className="md:max-w-none mx-auto rounded" src={Box} width={600} height={600} alt="Box of medication" style={{ top: '70%' }} />
                      {/* <Image className="md:max-w-none mx-auto rounded" src={FeaturesBg01} width={500} height={375} alt="Features bg" />
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <Image className="md:max-w-none mx-auto rounded" src={Tracking} width={600} height={600} alt="Track progress" />
                      {/* <Image className="md:max-w-none absolute w-full left-0 transform animate-float" src={FeaturesElement01} width={500} height={147} alt="Element 01" style={{ top: '22%' }} />
                      // <Image className="md:max-w-none absolute w-full left-0 transform animate-float animation-delay-500" src={FeaturesElement02} width={500} height={158} alt="Element 02" style={{ top: '39%' }} />
                      // <Image className="md:max-w-none absolute w-full left-0 bottom-0 transform animate-float animation-delay-1000" src={FeaturesElement03} width={500} height={167} alt="Element 03" style={{ top: '77%' }} /> */}
                    </div>
