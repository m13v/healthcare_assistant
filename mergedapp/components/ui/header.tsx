      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            {/* <h1 className="h3 font-uncut-sans mb-0 ml-3 aos-init aos-animate" data-aos="zoom-out" data-aos-delay="100">
              <span style={{ color: '#7DCC2C' }}>Bonsai</span>
            </h1> */}
            <Link href="/">
              <h1 className="h3 font-uncut-sans mb-0 ml-3 aos-init aos-animate" data-aos="zoom-out" data-aos-delay="100">
                <span className="bg-gradient-to-r bg-clip-text text-transparent from-green-500 to-teal-500 animate-text">Bonsai</span>
              </h1>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link href="/faq" className="text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">FAQ</Link>
              </li>
              {/* <li>
              ...
              <li>
                <Link href="/support" className="text-gray-600 hover:text-gray-900 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">Support center</Link>
              </li>
              {/* <li>
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link href="/signup" className="btn-sm text-gray-200 bg-teal-500 hover:bg-teal-800 ml-3">
