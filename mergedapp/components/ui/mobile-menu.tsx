      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="px-5 py-2">
            ...
            <li>
              <Link href="/faq" className="flex text-gray-600 hover:text-gray-900 py-2" onClick={() => setMobileNavOpen(false)}>FAQ</Link>
            </li>
            {/* <li>
            ...
            <li>
              <Link href="/support" className="flex text-gray-600 hover:text-gray-900 py-2" onClick={() => setMobileNavOpen(false)}>Support center</Link>
            </li>
            {/* <li>
            ...
            <li>
              <Link href="/signup" className="btn-sm text-gray-200 bg-teal-500 hover:bg-gray-800 w-full my-2" onClick={() => setMobileNavOpen(false)}>
                <span>Sign up</span>
